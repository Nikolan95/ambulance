        ...
        <div class="row vh-100 ">
            <div class="col-12 align-self-center">
                <div class="text-center auth-logo-text">
                    <h4 class="mt-0 mb-3 mt-5"> <img src="{{ asset('images/ambulance-logo.png') }}" alt="logo-large" class="logo-lg logo-dark"> </h4>
                    ...
                    <div class="card auth-card shadow-lg">
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <form class="form-horizontal auth-form my-4" action="{{ route('doctor.login') }}" method="GET">
                                @csrf
